...
import { register } from '../../../shared/api-client/api';
      ...
      <div style={{ width: '100%', maxWidth: '440px', padding: '0 1rem', position: 'relative', zIndex: 10 }}>
        <div style={{ background: 'var(--bg-primary)', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '2.5rem', boxShadow: 'var(--shadow-elevated)' }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h1 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '0.5rem', color: 'var(--text-primary)', letterSpacing: '-0.02em' }}>Create Account</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Start generating intelligent floor plans</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              ...
              <input 
                ...
                onBlur={e => e.target.style.borderColor = 'var(--input-border)'}
              />
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '6px' }}>Min 8 chars, 1 letter, 1 number</div>
            </div>
          ...
          <p style={{ textAlign: 'center', marginTop: '2rem', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            ...
            <Link to="/login" style={{ color: 'var(--accent-color)', textDecoration: 'none', fontWeight: 700 }}>Log in</Link>
          </p>
        </div>
      </div>
    </div>
